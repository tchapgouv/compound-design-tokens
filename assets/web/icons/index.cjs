module.exports = {
  ...
  ExportLogoIcon: require("./export-logo.cjs"),
  ...
  MultiDeviceIcon: require("./multi-device.cjs"),
  ...
  PadlockExternalIcon: require("./padlock-external.cjs"),
  PadlockForumIcon: require("./padlock-forum.cjs"),
  PadlockPrivateIcon: require("./padlock-private.cjs"),
  ...
  UserExportIcon: require("./user-export.cjs"),
