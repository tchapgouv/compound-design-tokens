...
val compoundColorsDark = SemanticColors(
    ...
    bgBadgeAccent = DarkColorTokens.colorBlue600,
    bgBadgeCritical = DarkColorTokens.colorRed400,
    bgBadgeDefault = DarkColorTokens.colorThemeBg,
    bgBadgeInfo = DarkColorTokens.colorBlue300,
    bgBadgePrimary = DarkColorTokens.colorAlphaGray700,
    bgBadgeSecondary = DarkColorTokens.colorGray400,
    bgBadgeSuccess = DarkColorTokens.colorGreen400,
    bgBadgeWarning = DarkColorTokens.colorOrange400,
    ...
    iconBadgeAccent = DarkColorTokens.colorGray1400,
    iconBadgeCritical = DarkColorTokens.colorRed1200,
    iconBadgeDefault = DarkColorTokens.colorGray1200,
    iconBadgeExternal = DarkColorTokens.colorOrange1200,
    iconBadgeInfo = DarkColorTokens.colorBlue1100,
    iconBadgePrimary = DarkColorTokens.colorThemeBg,
    iconBadgeSecondary = DarkColorTokens.colorGray1200,
    iconBadgeSuccess = DarkColorTokens.colorGreen1200,
    iconBadgeWarning = DarkColorTokens.colorOrange1200,
    ...
    textBadgeSuccess = DarkColorTokens.colorGreen1200,
    textBadgeWarning = DarkColorTokens.colorOrange1200,
