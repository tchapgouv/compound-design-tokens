...
public class CompoundUIColorTokens {
    ...
    public let bgBadgeCritical = UIColor(named: "bgBadgeCritical", in: Bundle.module, compatibleWith: nil)!
    ...
    public let bgBadgePrimary = UIColor(named: "bgBadgePrimary", in: Bundle.module, compatibleWith: nil)!
    public let bgBadgeSecondary = UIColor(named: "bgBadgeSecondary", in: Bundle.module, compatibleWith: nil)!
    public let bgBadgeSuccess = UIColor(named: "bgBadgeSuccess", in: Bundle.module, compatibleWith: nil)!
    public let bgBadgeWarning = UIColor(named: "bgBadgeWarning", in: Bundle.module, compatibleWith: nil)!
    ...
    public let bgSubtleTertiary = CompoundCoreUIColorTokens.gray100
    public let bgSuccessHovered = CompoundCoreUIColorTokens.green1000
    public let bgSuccessPressed = CompoundCoreUIColorTokens.green1100
    public let bgSuccessRest = CompoundCoreUIColorTokens.green900
    ...
    public let gradientCriticalStop1 = UIColor(named: "gradientCriticalStop1", in: Bundle.module, compatibleWith: nil)!
    public let gradientCriticalStop2 = UIColor(named: "gradientCriticalStop2", in: Bundle.module, compatibleWith: nil)!
    public let gradientInfoStop1 = UIColor(named: "gradientInfoStop1", in: Bundle.module, compatibleWith: nil)!
    public let gradientInfoStop2 = UIColor(named: "gradientInfoStop2", in: Bundle.module, compatibleWith: nil)!
    public let gradientSubtleStop1 = UIColor(named: "gradientSubtleStop1", in: Bundle.module, compatibleWith: nil)!
    public let gradientSubtleStop2 = UIColor(named: "gradientSubtleStop2", in: Bundle.module, compatibleWith: nil)!
    public let gradientSubtleStop3 = UIColor(named: "gradientSubtleStop3", in: Bundle.module, compatibleWith: nil)!
    public let gradientSubtleStop4 = UIColor(named: "gradientSubtleStop4", in: Bundle.module, compatibleWith: nil)!
    public let gradientSubtleStop5 = UIColor(named: "gradientSubtleStop5", in: Bundle.module, compatibleWith: nil)!
    public let gradientSubtleStop6 = UIColor(named: "gradientSubtleStop6", in: Bundle.module, compatibleWith: nil)!
    ...
    public let iconBadgeCritical = UIColor(named: "iconBadgeCritical", in: Bundle.module, compatibleWith: nil)!
    public let iconBadgeDefault = UIColor(named: "iconBadgeDefault", in: Bundle.module, compatibleWith: nil)!
    public let iconBadgeExternal = CompoundCoreUIColorTokens.orange1200
    public let iconBadgeInfo = UIColor(named: "iconBadgeInfo", in: Bundle.module, compatibleWith: nil)!
    public let iconBadgePrimary = UIColor(named: "iconBadgePrimary", in: Bundle.module, compatibleWith: nil)!
    public let iconBadgeSecondary = UIColor(named: "iconBadgeSecondary", in: Bundle.module, compatibleWith: nil)!
    public let iconBadgeSuccess = UIColor(named: "iconBadgeSuccess", in: Bundle.module, compatibleWith: nil)!
    public let iconBadgeWarning = UIColor(named: "iconBadgeWarning", in: Bundle.module, compatibleWith: nil)!
    ...
    public let iconWarningPrimary = CompoundCoreUIColorTokens.orange900
    ...
    public let textActionSuccess = CompoundCoreUIColorTokens.green900
    public let textBadgeAccent = UIColor(named: "textBadgeAccent", in: Bundle.module, compatibleWith: nil)!
    public let textBadgeCritical = UIColor(named: "textBadgeCritical", in: Bundle.module, compatibleWith: nil)!
    ...
    public let textBadgePrimary = UIColor(named: "textBadgePrimary", in: Bundle.module, compatibleWith: nil)!
    public let textBadgeSecondary = UIColor(named: "textBadgeSecondary", in: Bundle.module, compatibleWith: nil)!
    public let textBadgeSuccess = UIColor(named: "textBadgeSuccess", in: Bundle.module, compatibleWith: nil)!
    public let textBadgeWarning = UIColor(named: "textBadgeWarning", in: Bundle.module, compatibleWith: nil)!
    ...
    public let textWarningPrimary = CompoundCoreUIColorTokens.orange900
    public init() { }
}
